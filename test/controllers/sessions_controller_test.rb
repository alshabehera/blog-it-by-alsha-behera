...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_login_user_with_valid_credentials
    post session_path, params: { login: { email: @user.email, password: @user.password } }, headers: @auth_headers
  ...
  def test_shouldnt_login_user_with_invalid_credentials
    post session_path, params: { login: { email: @user.email, password: "invalid password" } }, headers: @auth_headers
  ...
  def test_should_respond_with_not_found_error_if_user_is_not_present
    ...
    post session_path, params: { login: { email: non_existent_email, password: "welcome" } }, headers: @auth_headers
